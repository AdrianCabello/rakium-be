  ...
  try {
    ...
    const project = await prisma.project.create({
      data: {
        ...
        description: 'Remodelación completa de estación de servicio',
        longDescription: 'Proyecto integral de remodelación incluyendo área de conveniencia y restaurante',
